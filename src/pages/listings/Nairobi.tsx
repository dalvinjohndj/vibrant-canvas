    ...
    <div>
      <section className="bg-gradient-primary text-white py-16">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-5xl font-bold mb-4">Properties in Nairobi</h1>
          <p className="text-xl opacity-90">Prime commercial opportunities in Kenya's business capital</p>
        </div>
      </section>
